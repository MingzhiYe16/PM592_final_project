...
co<-read_excel("C:/Users/yemin/Downloads/Consolidated data_vF.xlsx")
co<-co%>%
...
um3 <-
  glm(deaths ~ I(((percent65.c+0.1)/0.1)^3)+I(((percent65.c+0.1)/0.1)^3*log(((percent65.c+0.1)/0.1))) + offset(log(population)), 
      family = poisson,
      data = co)
summary(um3)
#density.c
...
subset_prelim <-
  MASS::stepAIC(
    glm(deaths ~ I(((stringency_index.c + 46.8)/100)^3) + 
          I(log((tests.c + 5532.3)/10000))+
          I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
    ...
    scope = list(upper =  ~ I(((stringency_index.c + 46.8)/100)^3) + 
                   I(log((tests.c + 5532.3)/10000))+
                   I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
                   I(((density.c + 147.3)/100)^0.5)+I(((density.c + 147.3)/100)^1)+
                   I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
...
mfp::mfp(deaths ~ fp(I(((stringency_index.c + 46.8)/100)^3)) + 
           I(log((tests.c + 5532.3)/10000))+
           I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
           I(((density.c + 147.3)/100)^0.5)+I(((density.c + 147.3)/100)^1)+
           I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
...
mfp::mfp(deaths ~ I(((stringency_index.c + 46.8)/100)^3) + 
...
mfp::mfp(deaths ~ I(((stringency_index.c + 46.8)/100)^3) + 
           I(log((tests.c + 5532.3)/10000))+
           I(((percent65.c + 0.1)/0.1)^3)+fp(I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1))))+
           I(((density.c + 147.3)/100)^0.5)+I(((density.c + 147.3)/100)^1)+
           I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
           I(log((household_size.c + 1.3))) +I(log((household_size.c + 1.3))^2) +
           I(((ghsa_score.c+30.2)/10)^2)+I(((ghsa_score.c+30.2)/10)^3) + offset(log(population)), 
...
prelim3 <- MASS::glm.nb(deaths ~ I(((stringency_index.c + 46.8)/100)^3)*I(log((tests.c + 5532.3)/10000))+
                          I(((density.c + 147.3)/100)^0.5)+I(((density.c + 147.3)/100)^1)+
                          I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
                          I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
                          I(log((household_size.c + 1.3))) +I(log((household_size.c + 1.3))^2) +
...
prelim4 <- MASS::glm.nb(deaths ~ I(log((tests.c + 5532.3)/10000))+
                          I(((density.c + 147.3)/100)^0.5)*I(((stringency_index.c + 46.8)/100)^3)+
                          I(((density.c + 147.3)/100)^1)*I(((stringency_index.c + 46.8)/100)^3)+
                          I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
                          I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
                          I(log((household_size.c + 1.3))) +I(log((household_size.c + 1.3))^2) +
                          I(((ghsa_score.c+30.2)/10)^2)+I(((ghsa_score.c+30.2)/10)^3) + offset(log(population)),
...
finalmodel <- MASS::glm.nb(deaths ~ I(((stringency_index.c + 46.8)/100)^3) + 
                          I(log((tests.c + 5532.3)/10000))+
                          I(((density.c + 147.3)/100)^0.5)+I(((density.c + 147.3)/100)^1)+
                          I(((percent65.c + 0.1)/0.1)^3)+I(((percent65.c + 0.1)/0.1)^3 * log(((percent65.c + 0.1)/0.1)))+
                          I(((temp.c + 18.3)/10)^1) +I(((temp.c + 18.3)/10)^2) +
